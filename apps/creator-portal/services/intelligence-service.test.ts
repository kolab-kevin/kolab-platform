...
import { fetchSessionIntelligence } from '@/services/intelligence-service';
...
describe('fetchSessionIntelligence', () => {
  it('returns mock session intelligence when mock mode is enabled', async () => {
    const result = await fetchSessionIntelligence(MOCK_COACH_SESSION_ID);
