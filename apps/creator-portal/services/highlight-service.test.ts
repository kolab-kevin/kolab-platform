...
import { fetchSessionHighlights } from '@/services/highlight-service';
...
describe('fetchSessionHighlights', () => {
  it('returns mock highlights when mock mode is enabled', async () => {
    const result = await fetchSessionHighlights(MOCK_LIVE_SESSION_ID);
